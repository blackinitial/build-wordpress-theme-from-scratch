...
?>
	...
	<section class="cta-section theme-bg-light py-5">
		<div class="container text-center single-col-max-width">
			<h2 class="heading">Halaman Archive</h2>
			<div class="intro">Category page</div>
	...
	<?php if ( have_posts() ) : ?>
		<section class="blog-list px-3 py-5 p-md-5">
			<div class="container gx-4 justify-content-between">
				<div class="row">
					<?php while ( have_posts() ) : ?>
						<?php the_post(); ?>
						<div class="col-4 mb-5">
							<div class="card row g-3 g-xl-0">
								<div class="card-body col-2 col-xl-3">
